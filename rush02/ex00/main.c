...
int	checknbr(char *nbr) //kontrola, ze input je cislo
{
	int	i;
...
char	*findnbr(char *nbr, char *b) //hledani radku strstr
{
	int		j;
	char	*ptr;
...
void	printnbr(char *d) //printovani cisel slovne
{
	int	i;
...
int	searchnbr(char *dict, char *nbr) //z decompose nejdrive najde radek ze slovniku na print
{
	char	*buf;
	char	*dentry;
	int		fd;
